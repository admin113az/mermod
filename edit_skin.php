...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE skins SET title=?, image_url=?, link=?, alt_text=?, description=? WHERE id=?";
...
<body>
<div class="container">
    <h1 class="mt-4">Chỉnh sửa Skin</h1>
    ...
    <?php if ($update_success): ?>
        <script>
            Swal.fire({
                ...
                icon: 'success',
                timer: 2000,  // Thay đổi thời gian đóng thông báo
    ...
    <form method="post" class="mt-3">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="image_url" name="image_url" value="<?php echo htmlspecialchars($skin['image_url'], ENT_QUOTES, 'UTF-8'); ?>" required>
        </div>
        <div class="form-group">
